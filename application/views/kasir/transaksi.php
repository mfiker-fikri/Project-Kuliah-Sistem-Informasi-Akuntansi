          ...
          <div class="card shadow">
            <div class="card-header border-0">
              <!-- <div class="row align-items-center"> -->
                <div class="col">
                  <h3 class="mb-0">Input Pembelian</h3>
                </div>
                ...
                <button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" onClick="refresh()" style="margin-bottom: 50px; margin-top: 20px">
                  <i class="fa fa-plus"></i>Tambah Data Pembelian</button>
...
<form method="get" action="">
        ...
        <a href="<?= base_url("index.php/kasir/transaksi"); ?>">Reset Filter</a>
    </form>
    <hr />
  ...
  <tr>
    ...
    <!--   <td><?php echo $trs->tgl_transaksi ?></td> -->
      ...
      <td style="cursor: pointer;" onClick="select_data_pembelian(
        '<?=$trs->transaksi_id ?>',
        '<?=$trs->nama_transaksi ?>',
        '<?=$trs->tgl_transaksi ?>',
      ...
      <td><a href="<?php echo base_url("index.php/kasir/Transaksi/hapus/".$trs->transaksi_id)?>"><i class="fa fa-trash"></i></a></td>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <Form method="POST"  action="<?php echo site_url('kasir/Transaksi/tambah_transaksi')?>">
        ...
        <button type="submit" class="btn btn-primary" name="tambah_transaksi">Save changes</button>
        </div>
        </Form>
