              ...
              <!-- <div class="row align-items-center"> -->
                ...
                <div class="col-12 my-3">
                 <!--  <a href="<?= base_url('data_akun/tambah') ?>" class="btn btn-primary mt-2">Tambah Transaksi</a>
                  ...
                  <!-- <button class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg" style="float:right">
                  <i class="fa fa-plus"></i>Tambah Jurnal umum</button> -->
                   <div class="col my-3">
                  <a href="<?= base_url('index.php/user/jurnal_umum/createJurnal') ?>" class="btn btn-primary mt-2">Tambah Jurnal</a>
                </div>
 ...
 <table id="myTable" class="table table-striped table-boarder" width="100%" align="center">
                ...
                <?php
                  ...
                  <tr>
                    ...
                    <td scope="col">
                        <?= form_open('user/jurnal_umum/jurnalUmumDetail','',['bulan'=>$bulan,'tahun'=>$tahun]) ?>
