                ...
                <div class="col-12 my-3">
                  <form action="<?= site_url($action) ?>" method="post">
                      <div class="form-group">
                        <label for="no_ref">Nomor Akun</label>
                        <p><?= form_error('no_reff') ?></p>
                        <input type="number" name="no_reff" class="form-control mb-3" id="no_reff" value="<?= $data->no_reff ?>">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="keterangan">Keterangan Akun</label>
                        <p><?= form_error('keterangan') ?></p>
                        <textarea name="keterangan" id="keterangan" cols="10" rows="5" class="form-control mb-3"><?= $data->keterangan ?></textarea>
                      </div>
