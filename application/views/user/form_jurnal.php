              ...
              <div class="row align-items-center">
                ...
                <div class="col-12 my-3 form-1">
                  ...
                  <div class="row mb-4">
                    <div class="col-4">
                        ...
                        <div class="input-group input-group-alternative">
                            ...
                            <input class="form-control" id="datepicker" name="tgl_transaksi" type="date" value="<?= $data->tgl_transaksi ?>">
                        </div>
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col">
                        <label for="reff">No Akun</label>
                        <input type="text" name="reff" class="form-control" id="reff" readonly>
                    </div>
                    <div class="col">
                        <label for="jenis_saldo">Jenis Saldo</label>
                        <?=form_dropdown('jenis_saldo',['debit'=>'Debet','kredit'=>'Kredit'],$data->jenis_saldo,['class'=>'form-control jenis_saldo','id'=>'jenis_saldo']);?>
