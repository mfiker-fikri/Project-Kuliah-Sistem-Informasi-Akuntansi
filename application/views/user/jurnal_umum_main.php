                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="d-flex justify-content-center">
                      <?= form_open('user/Jurnal_umum/editJurnal','',['id'=>$row->id_transaksi]) ?>
                      <?= form_button(['type'=>'submit','content'=>'','class'=>'btn btn-warning fa fa-pen mr-3']) ?>
                      <?= form_close() ?>

                      <?= form_open('user/Jurnal_umum/deleteJurnal',['class'=>'form'],['id'=>$row->id_transaksi]) ?>
                      <?= form_button(['type'=>'submit','content'=>'','class'=>'btn btn-danger fa fa-trash hapus']) ?>
                      <?= form_close() ?>
                    </td>       
                  </tr>
                  <?php 
