...
<body>
<div class="container-login100" style="background-image: url('<?php echo base_url('asset/') ?>images/img-01.jpg');">
...
<div class="container" style="margin-top: 50px">
 <div class="row">
        ...
        <img src="<?= base_url('asset/images/brand/Logo_akuntir.png') ?>" class="profile-img" alt="...">
        <span class="login100-form-title p-t-20 p-b-450 ">PT Tirta Medical Centre
		...
		<div class="container-login100" style="background-image: url('<?php echo base_url('asset/') ?>images/img-01.jpg');">
			<div class="wrap-login100  ">
				<form class="login100-form validate-form">
					...
					<span class="login100-form-title p-t-20 p-b-450 ">
						AKUNTIR
                    </span>
