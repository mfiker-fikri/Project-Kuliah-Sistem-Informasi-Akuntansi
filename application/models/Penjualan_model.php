...
class Penjualan_model extends CI_Model
{
   ...
   public function tambah_penjualan()
   {
    ...
    if($penjualan_id == null || $penjualan_id == "") {
   ...
   public function delete($penjualan_id){
    ...
    return $this->db->get('tb_penjualan')->result();// Tampilkan data transaksi sesuai tanggal yang diinput oleh user pada filter
  }
  ...
  public function view_by_month($month, $year){
    ...
    return $this->db->get('tb_penjualan')->result(); // Tampilkan data transaksi sesuai bulan dan tahun yang diinput oleh user pada filter
  }
    
  public function view_by_year($year){
        $this->db->where('YEAR(tgl_transaksi)', $year); // Tambahkan where tahun
        
    return $this->db->get('tb_penjualan')->result(); // Tampilkan data transaksi sesuai tahun yang diinput oleh user pada filter
  }
    
  public function view_all(){
    return $this->db->get('tb_penjualan')->result(); // Tampilkan semua data transaksi
  }
    
    public function option_tahun(){
        $this->db->select('YEAR(tgl_transaksi) AS tahun'); // Ambil Tahun dari field tgl_transaksi
        $this->db->from('tb_penjualan'); // select ke tabel transaksi
